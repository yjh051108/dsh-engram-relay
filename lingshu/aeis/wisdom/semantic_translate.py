...
DOMAIN_SYNONYM_CLUSTERS = {
    ...
    "溶解": ["糖化了", "盐化了", "变咸", "咸了", "放盐", "糖放水里不见了", "溶解",
             "溶于", "溶在水里", "怎么溶", "化在水里", "溶化", "糖放", "不见了", "糖不见了"],
    ...
    "声音传播": ["回声", "隔墙有耳", "声音传播", "传播", "发声", "响声", "声音怎么", "怎么传播"],
    # ---- 物理：电与磁 ----
    "电流": ["通电", "有电", "电流"],
    "电压": ["电压"],
    "电磁感应": ["发电", "电磁感应"],
    ...
    "检索": ["检索", "搜索", "查找", "怎么找", "找资料", "查资料", "搜一下", "搜", "找", "找东西", "查", "找找"],
    "存储": ["存储", "保存", "存下", "存起来", "保存下来", "留着以后用", "存着"],
    "验证": ["验证", "核实", "对不对", "是否属实", "靠谱吗", "怎么确认", "判断真伪"],
    "知识": ["知识", "学问", "概念", "常识", "道理", "知识体系"],
    # ---- 开发域（风识补簇：开发术语直配，桥接日常问法） ----
    "git版本控制": ["git", "回滚", "提交", "commit", "push", "pull", "分支", "版本管理"],
    "并发编程": ["多线程", "线程", "并发", "进程", "并行", "锁", "同步异步"],
    "数据结构": ["递归", "索引", "队列", "栈", "哈希", "链表", "树"],
    "容器化": ["docker", "容器", "镜像", "部署", "k8s"],
    "内存管理": ["内存", "泄漏", "堆", "栈内存", "gc", "回收", "缓存", "cache"],
    # ---- 扩展补簇（百查询审计：磁铁/汽化/天文/质数/API/编码等） ----
    "磁学": ["磁铁", "吸引", "吸铁", "磁性"],
    "汽化": ["汽化", "变气态", "蒸发", "变成气", "水蒸气"],
    "天文现象": ["东升西落", "圆缺", "影子", "日食", "月食", "自转"],
    "质数": ["质数", "素数", "质因数"],
    "接口": ["api", "接口", "端点", "请求接口"],
    "编程测试": ["单元测试", "测试用例", "集成测试", "调试"],
    "编码": ["编码", "解码", "编码解码", "encode", "decode"],
    "复杂度": ["复杂度", "算法复杂度", "时间复杂", "空间复杂"],
    "观测": ["观测工具", "观察方法", "检测手段", "观察方式"],
    "模型算法": ["模型", "算法模型", "机器学习模型"],
    "睡眠": ["睡觉", "睡眠", "休息", "睡着"],
    "检测": ["检测错误", "错误检测", "检测手段", "查错", "检查"],
    "概率": ["概率", "可能性", "随机", "几率", "机会多大", "概率论"],
    "自组织": ["自组织", "涌现", "无序到有序", "自我组织"],
    # ---- 开发域（风识补簇：开发术语直配，桥接日常问法） ----
    "git版本控制": ["git", "回滚", "提交", "commit", "push", "pull", "分支", "版本管理"],
    "并发编程": ["多线程", "线程", "并发", "进程", "并行", "锁", "同步异步"],
    "数据结构": ["递归", "索引", "队列", "栈", "哈希", "链表", "树"],
...
DOMAIN_ROUTE = {
    ...
    "科学方法论": "科学方法论",
    "加法": "数学", "概率": "数学", "自组织": "智能论",
    "磁学": "物理学", "汽化": "物理学", "天文现象": "天文学", "质数": "数学",
    "接口": "计算机科学", "编程测试": "工程学", "编码": "计算机科学",
    "复杂度": "计算机科学", "观测": "认知科学", "模型算法": "计算机科学",
    "睡眠": "生物学",
    "检测": "认知科学",
    # ---- 开发域路由（风识补簇） ----
    "git版本控制": "工程学", "并发编程": "工程学", "数据结构": "计算机科学",
    "容器化": "工程学", "内存管理": "计算机科学",
    # ---- 扩展路由（v1.16 · 110 题补缺） ----
