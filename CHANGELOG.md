## v0.3.74（2026-08-21）
- auto 通用卡入种子（红烧肉/煎蛋/毛衣——51 张种子开箱即用）

## v0.3.73（2026-08-21）
- 词网两级设计确认（168 簇——语义桶域分 + 卡名簇直接命中）

## v0.3.72（2026-08-21）
- verify 三态自测（采纳/无法判断诚实——白箱 D_norm）

## v0.3.71（2026-08-21）
- CHANGELOG 补齐 v0.3.66-70
## v0.3.70（2026-08-21）
- 边界容错自测（空/单字/特殊/超长输入全容错 + unknown_op 正常响应）

## v0.3.69（2026-08-21）
- 图谱端点健康确认（clean-dirty/search/graph 保守可见性）

## v0.3.68（2026-08-21）
- 补簇闭环第二例（代码风格 0.24→2.10——机制通用性确认）

## v0.3.67（2026-08-21）
- 学习趋势读数（learn_stats.log 快照 90% 强命中）

## v0.3.66（2026-08-21）
- 强化/遗忘机制代码路径验证（confirm/link→reinforce、检索→touch、排序→activation）
## v0.3.39（2026-08-21）
